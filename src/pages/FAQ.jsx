...
const FAQ = () => {
  return (
    <div className="page">
        ...
        <div id="1" className="detailfield">
        ...
        <div id="3" className="detailfield">
            ...
            <p>Once we've distilled a model, we can use it with our small, consumer hardware. To do this, <NamePlate /> leverages 
            ...
            <p>If you would like to see more technical details or contribute to this project, I 
                encourage you to check out the <a href="https://github.com/ColeDnought/logitlens.git">codebase</a>.
            </p>
        </div>
    </div>
  );

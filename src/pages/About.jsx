    ...
    <div className="page">
      ...
      <div className='columnView'>
        <div className='about-content detailfield'>
          ...
          <p>
            If you would like to see more technical details or contribute to this project, I encourage you to check out the <a href="https://github.com/cole-donat/logitviewer">GitHub repository</a>.
